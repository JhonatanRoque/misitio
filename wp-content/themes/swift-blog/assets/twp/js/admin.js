(function ($) {
    ...
    var ajaxurl = swift_blog_admin.ajax_url;
    var SwiftBlogNonce = swift_blog_admin.ajax_nonce;
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: swift_blog_admin.upload_image,
            button: {
            text: swift_blog_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'swift_blog_notice_dismiss',
            '_wpnonce': SwiftBlogNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-swift-blog-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-swift-blog-notice').addClass('twp-installing');

        var data = {
            'action': 'swift_blog_install_plugins',
            '_wpnonce': SwiftBlogNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = swift_blog_admin.active
            var deactivate = swift_blog_admin.deactivate
