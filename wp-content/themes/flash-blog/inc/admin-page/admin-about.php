...
if (!class_exists('Flash_Blog_Admin_About_page')):
    class Flash_Blog_Admin_About_page
    {
        ...
        {
            add_theme_page(esc_html__('Flash Blog Options', 'flash-blog'), esc_html__('Flash Blog Options', 'flash-blog'), 'activate_plugins', 'flash-blog-about', array($this, 'flash_blog_main_page'));
        }
        // Settings Form
            ...
            <div class="theme-admin-wrapper">
                <div class="theme-admin-top">
                    ...
                    <div class="theme-admin-button-block">
                        <a href="https://unitedtheme.com/themes/flash-blog/" class="theme-admin-button" target="_blank"> <?php echo esc_html__('Theme Details', 'flash-blog'); ?> </a>
                        <a href="https://unitedtheme.com/live-preview/flash-blog/" class="theme-admin-button" target="_blank"> <?php echo esc_html__('View Demo', 'flash-blog'); ?> </a>
                        ...
                        <a href="https://unitedtheme.com/themes/flash-blog-plus/" class="theme-admin-button" target="_blank"> <?php echo esc_html__('Upgrade To Pro', 'flash-blog'); ?>  </a>
                    </div>
                </div>
                        ...
                        <div class="theme-admin-support theme-tab-content">
                            ...
                            <div class="theme-admin-item">
                                ...
                                <div class="theme-admin-content">
                                    ...
                                    <a href="https://unitedtheme.com/submit-a-request/" class="theme-admin-button" target="_blank"><?php echo esc_html__('contact support', 'flash-blog'); ?></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul>
                                <li class="table-item">
                                    <ul class="table-data theme-equal-half">
                                        ...
                                        <li>
                                            <a href="https://unitedtheme.com/themes/flash-blog-plus/"
                ...
                <div class="theme-admin-footer">
                    ...
                    <a href="https://unitedtheme.com/themes/flash-blog-plus/" class="theme-admin-button"><?php echo esc_html__('Purchase', 'flash-blog'); ?> <?php echo esc_html($theme_name); ?> <?php echo esc_html__('Plus', 'flash-blog'); ?></a>
                </div>
            </div>
            <?php
        }
